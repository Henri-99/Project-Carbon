...
let SectionData = {
  ...
  // Hero data two
  heroDataTwo: {
    title: 'Play a part in reducing carbon emissions',
    content: 'write something sensible here from product team perhaps',
  ...
  itemDetailData: {
    ...
    title: 'Carbon Offset Project 1',
    content: 'Project info goes here',
    metaText: 'Org Name',
    metaTextTwo: 'Listing date: xx/xx/xx',
    metaTextThree: 'X Tokens remaining',
    btnText: 'Buy Carbon Credit',
    btnTextTwo: 'Share',
    itemDetailTabNav: [
      {
        id: 1,
  ...
  // Freatured data
  featuredData: {
    title: 'Newest Projects Added',
    content: 'Browse through the most recent projects added',
    featuredList: [
      {
        id: 1,
        img: require('@/images/thumb/art.jpg'),
        title: 'Carbon Offset Project 1',
        content: 'Project information will be included here in summary and user will be able to click to view more detail',
        path: '/item-details'
      },
      {
        id: 2,
        img: require('@/images/thumb/art-2.jpg'),
        title: 'Carbon Offset Project 2',
        content: 'Project information will be included here in summary and user will be able to click to view more detail',
        path: '/item-details'
      },
      {
  ...
  createData: {
    ...
    path: '/',
    title: 'Create and Issue Carbon Credits',
    cards: [
      {
        id: 1,
        title: 'Create',
  ...
  // about hero data
  aboutData: {
    title: 'What, Why, How info to go here - confirm with teams ',
    content: "Product team info to go here",
    contentTwo: "More info",
    contentThree: 'More info',
  ...
  registerData: {
    ...
    title: 'Register as a buyer/ seller ',
    subTitle: 'Please click on each tab and complete the below fields to register a new project. Once completed, please click create project.',
  ...
  contactData: {
    title: 'Contact Us',
    titleTwo: 'Reach out to us directly',
    subTitle: "Have a question? Fill in the below form and we’ll get back to you shortly.",
    ...
    contactList: [
      {
        ...
        icon: 'ni-mobile',
        title: 'Phone:',
        subTitle: '+27 795 515 7565'
      },
      {
        id: 2,
        icon: 'ni-globe',
        title: 'Web:',
        subTitle: 'https://www.finhub.org.za/'
      },
      {
        id: 3,
        icon: 'ni-mail',
        title: 'Email:',
        subTitle: 'hub@uct.ac.za'
      }
    ]
  },
  sidebarData: {
